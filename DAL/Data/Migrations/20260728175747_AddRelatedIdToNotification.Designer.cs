...
namespace DAL.Data.Migrations
{
    ...
    [Migration("20260728175747_AddRelatedIdToNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DefaultReminderTime = new TimeSpan(0, 20, 0, 0, 0),
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEP/F4fXhN2Md3EF/YV0tOB7YXkIH+zeuaeZtUY4RdDjzVLea7wnQHGDVw/Zbf+DgtA==",
            ...
            modelBuilder.Entity("DAL.Entities.Budget", b =>
                {
                    ...
                    b.Property<int?>("PreviousBudgetId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.BudgetIncomeSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.IncomeSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.SupportAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.BudgetIncomeSource", b =>
                {
                    b.HasOne("DAL.Entities.Budget", "Budget")
                        .WithMany("BudgetIncomeSources")
                        .HasForeignKey("BudgetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.IncomeSource", "IncomeSource")
                        .WithMany("BudgetIncomeSources")
            ...
            modelBuilder.Entity("DAL.Entities.IncomeSource", b =>
                {
                    b.HasOne("DAL.Entities.Budget", null)
            ...
            modelBuilder.Entity("DAL.Entities.SupportAttachment", b =>
                {
                    b.HasOne("DAL.Entities.SupportMessage", "Message")
            ...
            modelBuilder.Entity("DAL.Entities.SupportTicket", b =>
                {
                    b.HasOne("DAL.Entities.AppUser", "AssignedTo")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.Budget", b =>
                {
                    b.Navigation("BudgetIncomeSources");
